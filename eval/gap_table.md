...
**The comparison set.** 23 files were compared: 20 third-party files from 15 independent projects, 1 earlier ontology of this group, and 2 module(s) of this work. Several projects publish more than one file -- W3C/OGC SSN (3), InWaterSense (3), ETSI SAREF (2) -- so the file count and the project count differ and both are stated. Any sentence of the form "20 files from 15 independent projects" must use these two numbers together.
